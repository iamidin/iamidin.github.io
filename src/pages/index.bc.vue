<template>
  <!-- <header class="bg-cover bg-center h-screen relative"
    style="background-image: url('https://images.unsplash.com/photo-1558981403-c5f9899a28bc?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3');">
    <div class="absolute inset-0 bg-black opacity-70"></div>
    <div class="absolute inset-0 flex items-center">
      <div class="container mx-auto px-6 md:px-10">
        <p data-aos="flip-down" class="text-2xl md:text-3xl font-bold text-white">Hi, I'm Idin</p>&nbsp
        <p data-aos="fade-down" data-aos-delay="300" class="text-5xl md:text-6xl font-bold text-white">Fullstack Developer</p>&nbsp
        <p data-aos="fade-down" class="text-gray-200 italic mt-6 text-lg md:text-xl">"I’m from Indonesia and I have been working as a Programmer for more than 6 years. I’ve worked for several company in Indonesia as a Back-end Developer and Front-end Developer for 6 years."</p>
        <div class="mt-10 flex items-center gap-x-6 mt-20">
          <a href="#"
            ...
            Me</a>
          <a href="#" class="cursor-pointer font-semibold leading-6 text-gray-100 flex justify-center items-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 5L12 12" stroke="#ffffffff" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="0.2 0.2"/>
              <path d="M14 11L12.8321 12.7519C12.4362 13.3457 11.5638 13.3457 11.1679 12.7519L10 11" stroke="#ffffffff" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="0.2 0.2"/>
              <path d="M16.5 10H17.2C18.7464 10 20 11.2536 20 12.8L20 16.2026C20 17.7464 18.7495 18.9992 17.2057 18.9999C13.6163 19.0014 10.7217 18.9898 6.80685 18.992C5.25805 18.9929 4 17.7386 4 16.1898V12.8C4 11.2536 5.2536 10 6.8 10H7" stroke="#ffffffff" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
  ...
  <generic-panel>
    <div class="neutral h-screen">
      <div class="relative isolate flex items-center h-full">
        <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
          aria-hidden="true">
          <div
            class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-sky-500 to-blue-600 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)">
          </div>
        </div>
        <div class="container">
          <img src="https://avatars.githubusercontent.com/u/20946803?v=4" class="h-20 rounded-full mb-4" />
          ...
          <p data-aos="fade-down" class="text-gray-600 italic mt-6 text-lg md:text-xl">I’m from Indonesia and I have been working as a Programmer for more than 6 years. I’ve worked for several company in Indonesia as a Back-end Developer and Front-end Developer for 6 years.</p>
          <div class="flex items-center gap-x-6 mt-20">
            ...
            <a href="#" class="cursor-pointer font-semibold leading-6  flex justify-center items-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14 11L12.8321 12.7519C12.4362 13.3457 11.5638 13.3457 11.1679 12.7519L10 11" stroke="#0C0C0C" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="0.2 0.2"/>
                <path d="M16.5 10H17.2C18.7464 10 20 11.2536 20 12.8L20 16.2026C20 17.7464 18.7495 18.9992 17.2057 18.9999C13.6163 19.0014 10.7217 18.9898 6.80685 18.992C5.25805 18.9929 4 17.7386 4 16.1898V12.8C4 11.2536 5.2536 10 6.8 10H7" stroke="#0C0C0C" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
              <span class="ml-2">Download CV</span></a>
          </div>
        </div>
        <div
          ...
          aria-hidden="true">
          <div
            class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-sky-500 to-blue-600 opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
            style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)">
          </div>
        </div>
      </div>
  ...
  <div class="hero min-h-screen bg-base-200">
    <div class="hero-content text-center">
      <div class="max-w-xl">
        <h1 data-aos="fade-down" class="text-4xl md:text-7xl font-bold mb-6">Ahmad Muhyidin</h1>
        <p data-aos="fade-down" data-aos-delay="300" class="md:text-lg mb-6">Ahmad Muhyidin is a starter template project for Nuxt.js 3 + Tailwind CSS + Daisy UI with additional installed setup for custom font, icons, animation, and more.</p>
...
import ogBanner from '../assets/images/avatar.jpeg';
...
export default {
  ...
  setup () {
    ...
    useHead({
      ...
      description: 'Ahmad Muhyidin is a starter template for Nuxt.js 3 + Tailwind CSS + Daisy UI with additional installed setup for custom font, icons, animation, and more.',
      link: [
